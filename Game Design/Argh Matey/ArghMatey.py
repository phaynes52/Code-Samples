...
name = raw_input("Bouncer: 'Ahoy Matey and welcome to The Ship! If you're on the list head in. If not, walk the plank. What's your name?' \nEnter your name: ")

raw_input("Bouncer: '{}, {}, {}. Ah! There it is! Head on in.'".format(name, name, name))
