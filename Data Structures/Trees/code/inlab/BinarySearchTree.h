...
class BinarySearchTree {
 public:
  ...
  bool isIdentical( *binaryNode a, *binaryNode b);
 ...
 private:
  ...
  string pathToHelper(const string& x, BinaryNode* nroot) const;
  void insertHelper(const string& x, BinaryNode* & nroot);
  bool findHelper(const string& x, BinaryNode* nroot) const;
  int numNodesHelper(BinaryNode* nroot) const;
  bool isIdenticalHelper( *binaryNode a, *binaryNode b) const;
