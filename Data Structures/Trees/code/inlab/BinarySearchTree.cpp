...
bool isIdentical( *binaryNode a, *binaryNode b){
  return isIdenticalHelper(a,b);
}

bool isIdenticalHelper( *binaryNode a, *binaryNode b){
  bool resutl1 = True;
  bool result2 = True;
  if( a->value != b->value){
    return false;
  ...
  if( a->left != NULL && b->left != NULL ){
    result1 = isIdentical(a->left, b->left);
  }
  else if(a->right != NULL || b->left!= NULL){ return false;}
