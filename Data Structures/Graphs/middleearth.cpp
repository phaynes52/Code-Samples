...
/** The list of all the places names that we'll be using*/
...
/**
    * \brief Creates Middle Earth by choosing a number of cities to include.
    *
    * This function acts as the constructor for the MiddleEarth class
    * \return no return, creates an object of type MiddleEarth
    * \param xsize width of the graph.
    * \param ysize height of the graph.
    * \param num_cities defines how many cities to include in the graph.
    * \param seed gives a seed for the random generator.
*/
...
/**
    ...
    *
    *  This function is the destructor for the MiddleEarth type.
*/
...
/** 
    ...
    *
    * This function prints how many city choices there are, how many we are using, and lists the cities used and their location.
*/
...
/**
    * \brief Brief: Prints distance table
    *
...
/**
    * \brief Brief: gets distance between two cities
    *
    ...
    *
    * \return the float distance between the two cities.
    * \param city1 the first city to on the path - where the distance is calculated from.
    * \param city2 the second city on the path - where the distance is calculated to.
 */
...
/**
    * \brief Brief: returns list of cities to travel to
    *
    * The first city is the original start point as well as the end point.  The number of
    * cities passed in does not include this start/end point (so there will be length+1 entries in the returned vector).
    *
    * \param length the number of cities to visit.
*/
vector<string> MiddleEarth::getItinerary (unsigned int length) {
    length++; ///< accounts for for the start point
    // check parameter
